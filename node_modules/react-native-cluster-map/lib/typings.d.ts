...
export interface IClusterMapProps extends MapViewProps {
    ...
    renderClusterMarker: (renderClusterMarkerOptions: {
        pointCount: number;
        clusterId: number;
    }) => ReactNode;
    onMapReady: () => void;
    onClusterClick: (clusterClickEvent?: IClusterClickEvent, clusterChildren?: Array<SuperCluster.ClusterFeature<any>> | Array<SuperCluster.PointFeature<any>>) => void;
